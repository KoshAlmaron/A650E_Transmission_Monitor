...
TablesData = [{'N': 0,	'Menu': 0,	'Table': 'SLTGraph',					'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 100,		'Max': 800,		'Step': 4,	'Parameter': 'GearChangeSLT',	'Name': 'SLT - Линейное давление от нагрузки'}
			...
			, {'N': 2,	'Menu': 0,	'Table': 'SLNGraph',					'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 0,		'Max': 800,		'Step': 4,	'Parameter': 'GearChangeSLN',	'Name': 'SLN - Давление подпора гидроаккумуляторов от нагрузки'}
			...
			, {'N': 4,	'Menu': 1,	'Table': 'SLUGear2Graph',				'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 100,		'Max': 500,		'Step': 4,	'Parameter': 'GearChangeSLU',	'Name': 'SLU G2 - Давление включения второй передачи от нагрузки'}
			...
			, {'N': 8,	'Menu': 1,	'Table': 'GearChangeStepArray',			'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 1,		'Max': 120,		'Step': 5,	'Parameter': '',				'Name': 'G2 - Длительность 1 шага включения передачи'}
			, {'N': 9,	'Menu': 2,	'Table': 'Gear2AdvGraph',				'ArrayX': DeltaRPMGrid,	'Type': 'int16_t',	'Size' : 0,	'Min': 0,		'Max': 1200,	'Step': 25,	'Parameter': '',				'Name': 'RPM G2 - Опережение по оборотам реактивации второй передачи'}
			, {'N': 10,	'Menu': 2,	'Table': 'Gear2AdvAdaptGraph',			'ArrayX': DeltaRPMGrid,	'Type': 'int16_t',	'Size' : 0,	'Min': -300,	'Max': 300,		'Step': 25,	'Parameter': '',				'Name': '    RPM G2 - Адаптация оборотов реактивации второй передачи'}
			, {'N': 11,	'Menu': 2,	'Table': 'Gear2AdvTempCorrGraph',		'ArrayX': TempGrid,		'Type': 'int16_t',	'Size' : 0,	'Min': -300,	'Max': 300,		'Step': 25,	'Parameter': '',				'Name': 'RPM G2 - Температурная коррекция оборотов реактивации второй передачи'}
			, {'N': 12,	'Menu': 2,	'Table': 'Gear2AdvTempAdaptGraph',		'ArrayX': TempGrid,		'Type': 'int16_t',	'Size' : 0,	'Min': -300,	'Max': 300,		'Step': 25,	'Parameter': '',				'Name': '    RPM G2 - Адаптация температурной коррекции оборотов реактивации второй передачи'}
			, {'N': 13,	'Menu': 3,	'Table': 'SLUGear3Graph',				'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 100,		'Max': 500,		'Step': 4,	'Parameter': 'GearChangeSLU',	'Name': 'SLU G3 - Давление включения третьей передачи от нагрузки'}
			, {'N': 14,	'Menu': 3,	'Table': 'SLUGear3DelayGraph',			'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 0,		'Max': 800,		'Step': 20,	'Parameter': '',				'Name': 'SLU G3 - Время удержания от нагрузки при включении третьей передачи'}
			, {'N': 15,	'Menu': 3,	'Table': 'SLUGear3TPSAdaptGraph',		'ArrayX': TPSGrid,		'Type': 'int16_t',	'Size' : 0,	'Min': -200,	'Max': 200,		'Step': 20,	'Parameter': '',				'Name': '    SLU G3 - Адаптация времени удержания третьей передачи по нагрузке'}
			...
			, {'N': 18,	'Menu': 3,	'Table': 'SLNGear3Graph',				'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 0,		'Max': 800,		'Step': 4,	'Parameter': 'GearChangeSLN',	'Name': 'SLN G3 - Давление SLN включения третьей передачи от нагрузки'}
			...
			, {'N': 20,	'Menu': 0,	'Table': 'SLNGear5Graph',				'ArrayX': TPSGrid,		'Type': 'uint16_t',	'Size' : 0,	'Min': 0,		'Max': 800,		'Step': 4,	'Parameter': '',				'Name': 'SLN G5 - Давление SLN включения пятой передачи от нагрузки'}
			, {'N': 21,	'Menu': 4,	'Table': 'TPSGraph',					'ArrayX': TPSGrid,		'Type': 'int16_t',	'Size' : 0,	'Min': 0,		'Max': 1023,	'Step': 4,	'Parameter': '',				'Name': 'ДПДЗ/Нагрузка (показания АЦП)'}
			, {'N': 22,	'Menu': 4,	'Table': 'OilTempGraph',				'ArrayX': TempGrid,		'Type': 'int16_t',	'Size' : 0,	'Min': 0,		'Max': 1023,	'Step': 4,	'Parameter': '',				'Name': 'Температура масла (показания АЦП)'}
			, {'N': 23,	'Menu': 5,	'Table': 'GearSpeedGraphs',				'ArrayX': TPSGrid,		'Type': 'uint8_t',	'Size' : 0,	'Min': 0,		'Max': 150,		'Step': 1,	'Parameter': '',				'Name': 'Графики переключений передач'}
]
