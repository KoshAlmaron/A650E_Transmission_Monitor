...
class _SpeedEditWindow:
	...
	def add_tooltip(self):	# Вставка подсказок.
		...
		ToolTip.ToolTip(self.ExportBtn, "Экспорт текущего графика в буфер обмена. Значения передаюся в буфер с разделителем-табуляцией для дальнейшей вставки в Excel.")
